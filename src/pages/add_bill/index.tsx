        ...
        <>
            <div className="flex items-center justify-between flex-wrap gap-3 lg:mb-5 mb-5">
                ...
                <div className="flex flex-col md:flex-row w-full md:w-auto space-y-3 md:space-y-0 md:space-x-3">
                    <Button
                        className="bg-purple hover:bg-primary-700 text-white w-full sm:w-auto"
                                ...
                                <ul>
                                    {bills.map((bill) => (
                                        ...
                                        >
                                            ...
                                            <Button className="bg-purple text-white hover:bg-primary-700 text-sm px-4 py-1 h-auto w-full sm:w-auto">
                                                View
                                            </Button>
                                        </li>
                                    ))}
