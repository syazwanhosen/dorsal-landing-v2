      ...
      <div className="p-6 bg-white rounded-lg shadow-md lg:mt-6 mt-4 lg:mb-8 mb-4">
          ...
          <table className="table-auto w-full">
            ...
            <thead>
              <tr className="pb-4">
                ...
                <th className="p-3 font-semibold text-center lg:py-4">
                  Quantity
                </th>
                <th className="p-3 font-semibold text-right lg:py-4">
                  Unit Cost (USD)
                </th>
                <th className="p-3 font-semibold text-right lg:py-4">
                  Amount (USD)
            ...
            <tbody>
              {[
                {
                  code: "123",
                  desc: "Coronary Artery Bypass Surgery",
                  qty: 1,
                  unit: "9,574.47",
                  amt: "9,574.47",
                },
                ...
                {
                  code: "456",
                  desc: "Operating Theatre & Equipment",
                  qty: 1,
                  unit: "1,808.51",
                  amt: "1,808.51",
                },
        ...
        <div className="block lg:hidden">
          {[
            ...
            <div
              key={index}
              className="p-4 border-b border-gray-300 rounded-lg shadow-md bg-white"
            >
          ...
          <button className="bg-gradient-to-r bg-[#8771BC] text-white px-6 py-2 rounded-md flex items-center shadow-md hover:shadow-lg transition-shadow w-full justify-center mt-4">
            Run Audit
          </button>
        </div>
